...
object orbital {
	...
	last.state.t                              //> res2: Double = 2109.8458996826425
	last.state                                //> res3: net.paploo.orbital.State = State(2109.8458996826425,PhysVec(700001.268
                                                  //| 745336,-6.959514635671901,0.0),PhysVec(0.02180847500915307,2299.997990440803
                                                  //| 3,0.0))
	last.apses                                //> res4: (Double, Double) = (700001.2687783306,771413.919850391)
	last.period                               //> res5: Double = 2109.851907688307
}