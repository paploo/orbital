...
object orbital {
	...
	val initialState = State(0.0, PhysVec(700000.0, 0.0), PhysVec(0.0, 2300.0), Planetoid.kerbin)
                                                  ...
                                                  //| 5000.0))
	val rocket = new UnpoweredRocket(initialState, 10.0, BlackBox.empty)
	...
	val start = System.currentTimeMillis      //> start  : Long = 1371278221804
	val last = rocket.runWhile(_.state.t < rocket.period)(0.0001)
                                                  ...
                                                  //| 0,21600.0,5000.0)))
	val stop = System.currentTimeMillis       //> stop  : Long = 1371278228533
	
	stop - start                              //> res2: Long = 6729
